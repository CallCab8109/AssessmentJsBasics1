...
const analysisOfRequirements = "Assessing what needs to be done and what is required of the code you're building"
const design = "desingning code and an algorythm to meet the requirements"
const implementation = "actually creating the code"
const testingAndIntegration = "testing and integrating your code into the user interface"
const maintain = "maintaining your code to keep it user friendly"